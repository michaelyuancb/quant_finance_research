...
def debug_panel_orth_global_symmetry():
...
def debug_panel_orth_global_standard():
    df, df_column = _get_fX_df(rest=8)
    df_val = copy.deepcopy(df)
    top_k = None
...
def debug_panel_orth_global_custom():
...
def debug_panel_orth_global_residual():
...
def debug_panel_orth_local_residual():
...
if __name__ == "__main__":
    # debug_orth_global_symmetry()
    # debug_orth_global_standard()
    # debug_orth_global_custom()
    # debug_orth_global_residual()
    debug_orth_local_residual()